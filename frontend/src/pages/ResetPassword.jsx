...
function UptoskillsMark({ size = 'md' }) {
  ...
  return (
    <svg viewBox="0 0 40 40" className={dim} aria-hidden="true">
      ...
      <rect x="0" y="0" width="40" height="40" rx="10" fill="url(#us-grad-rp)" />
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-base mesh-gradient p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-raised border border-border rounded-md shadow-sm p-7">
          ...
          <p className="text-sm text-fg-muted mt-1.5">Enter a new password for your account. Must be at least 8 characters.</p>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mt-5">
                ...
                <Input
                  ...
                  leftIcon={<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75"><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0110 0v4" /></svg>}
                />
                <Button type="submit" variant="primary" loading={submitting} className="w-full">Reset password</Button>
              </form>
            </>
          )}
